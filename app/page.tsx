      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100">
        ...
        <footer className="py-12 bg-gray-900 text-white">
          <div className="container mx-auto px-4 text-center">
            ...
            {/* Section for names */}
            <div className="mt-8">
              <p className="text-sm font-semibold text-gray-400 mb-2">Created By:</p>
              <p className="text-gray-500 text-sm">
  Aadesh Gavhane, Siddhi Jadhav, Pooja Maskare, Kartika Thite
</p>
              <p className="text-sm font-semibold text-gray-400 mt-4 mb-2">Guided By:</p>
              <p className="text-sm text-gray-500">Prof. Vishal Badguar</p>
            </div>
